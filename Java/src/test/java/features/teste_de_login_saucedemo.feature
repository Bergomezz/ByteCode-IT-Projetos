...
Funcionalidade: Testando Login
  ...
  Esquema do Cenario:
    ...
    Exemplos:
      | casoTeste  | usuario                   | pass           | resposta                                                                    |
      | "valido"   | "standard_user"           | "secret_sauce" | "Products"                                                                  |
      | "valido"   | "problem_user"            | "secret_sauce" | "Products"                                                                  |
      | "valido"   | "performance_glitch_user" | "secret_sauce" | "Products"                                                                  |
